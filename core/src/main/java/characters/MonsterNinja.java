...
public class MonsterNinja {
    ...
    public MonsterNinja(final World world, final float x_px, final float y_px){
        sprite = SpriteLoader.getSprite("images/monsterninja.json");
