...
public class Digit5 {
    ...
    public Digit5(final float x_px, final float y_px){
        sprite = SpriteLoader.getSprite("images/digit5.json");
    ...
    public  void update(int delta) {
        ...
        if(GameScreen.numberdigit5 == 0){
            state = State.NUMBER0;
        }else if (GameScreen.numberdigit5 == 1){
            state = State.NUMBER1;
        }else if (GameScreen.numberdigit5 == 2){
            state = State.NUMBER2;
        }else if (GameScreen.numberdigit5 == 3){
            state = State.NUMBER3;
        }else if (GameScreen.numberdigit5 == 4){
            state = State.NUMBER4;
        }else if (GameScreen.numberdigit5 == 5){
            state = State.NUMBER5;
        }else if (GameScreen.numberdigit5 == 6){
            state = State.NUMBER6;
        }else if (GameScreen.numberdigit5 == 7){
            state = State.NUMBER7;
        }else if (GameScreen.numberdigit5 == 8){
            state = State.NUMBER8;
        }else if (GameScreen.numberdigit5 == 9){
            state = State.NUMBER9;
        }
        e += delta;
