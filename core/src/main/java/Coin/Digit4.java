...
public class Digit4 {
    ...
    public Digit4(final float x_px, final float y_px){
        sprite = SpriteLoader.getSprite("images/digit4.json");
    ...
    public  void update(int delta) {
        ...
        if(GameScreen.numberdigit4 == 0){
            state = State.NUMBER0;
        }else if (GameScreen.numberdigit4 == 1){
            state = State.NUMBER1;
        }else if (GameScreen.numberdigit4 == 2){
            state = State.NUMBER2;
        }else if (GameScreen.numberdigit4 == 3){
            state = State.NUMBER3;
        }else if (GameScreen.numberdigit4 == 4){
            state = State.NUMBER4;
        }else if (GameScreen.numberdigit4 == 5){
            state = State.NUMBER5;
        }else if (GameScreen.numberdigit4 == 6){
            state = State.NUMBER6;
        }else if (GameScreen.numberdigit4 == 7){
            state = State.NUMBER7;
        }else if (GameScreen.numberdigit4 == 8){
            state = State.NUMBER8;
