...
public class Digit6 {
    ...
    public Digit6(final float x_px, final float y_px){
        sprite = SpriteLoader.getSprite("images/digit6.json");
    ...
    public  void update(int delta) {
        ...
        if(GameScreen.numberdigit6 == 0){
            state = State.NUMBER0;
        }else if (GameScreen.numberdigit6 == 1){
            state = State.NUMBER1;
        }else if (GameScreen.numberdigit6 == 2){
            state = State.NUMBER2;
        }else if (GameScreen.numberdigit6 == 3){
            state = State.NUMBER3;
        }else if (GameScreen.numberdigit6 == 4){
            state = State.NUMBER4;
        }else if (GameScreen.numberdigit6 == 5){
            state = State.NUMBER5;
        }else if (GameScreen.numberdigit6 == 6){
            state = State.NUMBER6;
        }else if (GameScreen.numberdigit6 == 7){
            state = State.NUMBER7;
        }else if (GameScreen.numberdigit6 == 8){
            state = State.NUMBER8;
        }else if (GameScreen.numberdigit6 == 9){
            state = State.NUMBER9;
        }
        e += delta;
